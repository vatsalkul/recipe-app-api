...
class PublicUserApiTests(TestCase):
    ...
    def test_user_exists(self):
        """Test creating a user that alreay exists"""
        payload = {
            'email': 'vatsal@gmail.com',
            'password': 'testpass'
        }
    ...
    def test_password_too_short(self):
        """Test that password must be more than 5 charactres"""
        payload = {
            'email': 'vatsal@gmail.com',
            'password': 'pw'
        }
    ...
    def test_create_token_invalid_credentials(self):
        ...
        create_user(email='vatsal@gmail.com', password='testpass')
        payload = {
            'email': 'vatsal@gmail.com',
            'password': 'asdfgh'
        }
...
class PrivateuserApiTests(TestCase):
    """Test api requests that require authentoication"""
    ...
    def test_retrived_profile_success(self):
